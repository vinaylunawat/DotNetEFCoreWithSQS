namespace Geography.Business.Country.Manager
{
    ...
    /// </summary>
    public class CountryCommandManager : CodeCommandManager<GeographyDbContext, GeographyReadOnlyDbContext, CountryErrorCode, Country, CountryCreateModel, CountryUpdateModel>, ICountryCommandManager
    {
        /// <summary>
        ...
        /// <returns>The <see cref="Task{ErrorRecords{CountryErrorCode}}"/>.</returns>
        protected override Task CreateAfterSaveAsync(IList<IIndexedItem<CountryCreateModel>> indexedItems, IList<Country> entities)
        {
            _queueManager.SendMessageAsync(_amazonSQSConfigurationOptions, JsonConvert.SerializeObject(indexedItems));
